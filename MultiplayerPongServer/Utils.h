#ifndef __MPS_UTILS_H__
#define __MPS_UTILS_H__
...
inline std::string MakeInitPackage(char player, char ballx, char bally, char ballvx, char ballvy)
{
    std::string package;
    std::stringstream ss;

    ss << PACKAGE_HEAD;
    ss << PACKAGE_TYPE_INIT;
    ss << (char)5;
    ss << player;
    ss << ballx;
    ss << bally;
